...
sound_file sound_table[] = {
  ...
  { cereal::CarControl::HUDControl::AudibleAlert::CHIME_DOOROPEN, "../assets/sounds/dooropen.wav", false },
  { cereal::CarControl::HUDControl::AudibleAlert::CHIME_GEARDRIVE, "../assets/sounds/geardrive.wav", false },
  { cereal::CarControl::HUDControl::AudibleAlert::CHIME_LANECHANGE, "../assets/sounds/lanechange.wav", false },
  { cereal::CarControl::HUDControl::AudibleAlert::CHIME_LANEDEPARTURE, "../assets/sounds/lanedeparture.wav", false },
  { cereal::CarControl::HUDControl::AudibleAlert::CHIME_ROADWARNING, "../assets/sounds/roadwarning.wav", false },
  { cereal::CarControl::HUDControl::AudibleAlert::CHIME_SEATBELT, "../assets/sounds/seatbelt.wav", false },
  { cereal::CarControl::HUDControl::AudibleAlert::CHIME_VIEWUNCERTAIN, "../assets/sounds/viewuncertain.wav", false },
