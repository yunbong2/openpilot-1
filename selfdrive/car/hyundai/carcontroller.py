...
#     lkas_active = enabled and self.lkas_button
    ...
    if CS.left_blinker_on or CS.right_blinker_on:
      if self.car_fingerprint not in [CAR.K5, CAR.K5_HYBRID, CAR.GRANDEUR_HYBRID, CAR.KONA_EV, CAR.STINGER, CAR.SONATA_TURBO, CAR.IONIQ_EV, CAR.SORENTO, CAR.GRANDEUR, CAR.K7, CAR.K7_HYBRID, CAR.NEXO, CAR.NIRO, CAR.NIRO_EV]:
