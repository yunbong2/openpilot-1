...
def check_car_battery_voltage(should_start, health, charging_disabled, msg):
  ...
  if charging_disabled and (health is None or health.health.voltage > 12300) and msg.thermal.batteryPercent < 60:
    charging_disabled = False
    os.system('echo "1" > /sys/class/power_supply/battery/charging_enabled')
  elif not charging_disabled and (msg.thermal.batteryPercent > 70 or (health is not None and health.health.voltage < 11800 and not should_start)):
